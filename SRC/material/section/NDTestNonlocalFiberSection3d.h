...
#ifndef NDTestNonlocalFiberSection3d_h
#define NDTestNonlocalFiberSection3d_h
...
class NDTestNonlocalFiberSection3d : public SectionForceDeformation
{
  public:
    NDTestNonlocalFiberSection3d(); 
    NDTestNonlocalFiberSection3d(int tag, int numFibers, Fiber **fibers, double a = 1.0, bool compCentroid=true);
    NDTestNonlocalFiberSection3d(int tag, int numFibers, double a = 1.0, bool compCentroid=true);
    NDTestNonlocalFiberSection3d(int tag, int numFibers, NDMaterial **mats,
		     SectionIntegration &si, double a = 1.0, bool compCentroid=true);
    ~NDTestNonlocalFiberSection3d();

    const char *getClassType(void) const {return "NDTestNonlocalFiberSection3d";};
