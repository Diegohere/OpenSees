...
#ifndef NDTestShear4WFFiberSection3d_h
#define NDTestShear4WFFiberSection3d_h
...
class NDTestShear4WFFiberSection3d : public SectionForceDeformation
{
  public:
    NDTestShear4WFFiberSection3d(); 
    NDTestShear4WFFiberSection3d(int tag, double bf, double tf, double d, double tw, int numFibers, Fiber **fibers, double a = 1.0, bool compCentroid=true);
    NDTestShear4WFFiberSection3d(int tag, double bf, double tf, double d, double tw, int numFibers, double a = 1.0, bool compCentroid=true);
    NDTestShear4WFFiberSection3d(int tag, double bf, double tf, double d, double tw, int numFibers, NDMaterial **mats,
		     SectionIntegration &si, double a = 1.0, bool compCentroid=true);
    ~NDTestShear4WFFiberSection3d();

    const char *getClassType(void) const {return "NDTestShear4WFFiberSection3d";};
