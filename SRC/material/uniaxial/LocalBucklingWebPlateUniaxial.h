...
#ifndef CPP_LocalBucklingWebPlateUniaxial_H
#define CPP_LocalBucklingWebPlateUniaxial_H
...
class LocalBucklingWebPlateUniaxial : public UniaxialMaterial
{
...
public:
	...
	LocalBucklingWebPlateUniaxial(int tag, double E, double poissonRatio, double sy0,
	...
	LocalBucklingWebPlateUniaxial(void);

	// Destructor
	~LocalBucklingWebPlateUniaxial();
...
#endif //CPP_LocalBucklingWebPlateUniaxial_H