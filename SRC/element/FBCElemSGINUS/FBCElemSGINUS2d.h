...
#ifndef FBCElemSGINUS2d_H 
#define FBCElemSGINUS2d_H 
...
class FBCElemSGINUS2d : public Element
{
public:
	...
	FBCElemSGINUS2d(int tag, int nodeI, int nodeJ,
...
public:
	...
	const char* getClassType(void) const { return "FBCElemSGINUS2d"; };
