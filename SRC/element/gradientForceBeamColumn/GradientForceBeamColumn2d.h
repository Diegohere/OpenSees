//
// Created by Diego Heredia on 31.08.20
//

#ifndef GradientForceBeamColumn2d_H 
#define GradientForceBeamColumn2d_H 
...
class GradientForceBeamColumn2d : public Element
{
public:
	// Constructor, parallel processing
	GradientForceBeamColumn2d();

	// Constructor, called by clients
	// Based on the current ForceBeamElement OpenSees manual
	GradientForceBeamColumn2d(int tag, int nodeI, int nodeJ,
...
private:
	...
	void computeDeStar_nonlocal(int numSections, Matrix& deStar_nonlocal, Matrix H_inv, Matrix deStar_local);
	void computeE_local(int numSections, Vector eNonLocalSubdivide[], Matrix H, Matrix& e_local_tot);
	void computeEu_nonlocal(int numSections, Matrix& eu_nonlocal, Matrix H_inv, Matrix eu_local);
	void computeFelement_nonlocal(int numSections, Matrix& Felement_nonlocal, Matrix H_inv, Matrix FSectionSubdivide[]);
...
#endif // GradientForceBeamColumn2d_H 
