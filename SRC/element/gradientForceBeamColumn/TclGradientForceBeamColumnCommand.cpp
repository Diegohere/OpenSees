...
#include "GradientForceBeamColumn2d.h"
...
int
TclModelBuilder_addGradientForceBeamColumn(ClientData clientData, Tcl_Interp* interp,
	int argc,
	TCL_Char** argv,
	Domain* theTclDomain,
	TclModelBuilder* theTclBuilder)
{
	...
	if (theTclBuilder == 0) {
		opserr << "WARNING builder has been destroyed - gradientForceBeamColumn\n";
		return TCL_ERROR;
	}
	...
	if (ndm == 2) {
		...
		if (ndf != 3) {
			...
			opserr << ", for 2d simulation nDOF must be 3 - gradientForceBeamColumn\n";
			return TCL_ERROR;
		}
