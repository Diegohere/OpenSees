...
#ifndef GradientForceBeamColumn3d_H 
#define GradientForceBeamColumn3d_H 
...
class GradientForceBeamColumn3d : public Element
{
public:
	// Constructor, parallel processing
	GradientForceBeamColumn3d();

	// Constructor, called by clients
	// Based on the current ForceBeamElement OpenSees manual
	GradientForceBeamColumn3d(int tag, int nodeI, int nodeJ,
...
#endif // GradientForceBeamColumn3d_H 
