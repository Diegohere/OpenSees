...
#ifndef FBCElemKNSGINUS2d_H 
#define FBCElemKNSGINUS2d_H 
...
class FBCElemKNSGINUS2d : public Element
{
public:
	...
	FBCElemKNSGINUS2d(int tag, int nodeI, int nodeJ,
...
public:
	...
	const char* getClassType(void) const { return "FBCElemKNSGINUS2d"; };
