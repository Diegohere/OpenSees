...
#ifndef FBCElemKNSGINUS3d_H 
#define FBCElemKNSGINUS3d_H 
...
class FBCElemKNSGINUS3d : public Element
{
public:
	...
	FBCElemKNSGINUS3d(int tag, int nodeI, int nodeJ,
...
public:
	...
	const char* getClassType(void) const { return "FBCElemKNSGINUS3d"; };
