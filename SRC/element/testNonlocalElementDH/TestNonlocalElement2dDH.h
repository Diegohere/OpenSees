//
// Created by Diego Heredia on 31.07.23
//

#ifndef TestNonlocalElement2dDH_H 
#define TestNonlocalElement2dDH_H 
...
class TestNonlocalElement2dDH : public Element
{
public:
	// Constructor, parallel processing
	TestNonlocalElement2dDH();

	// Constructor, called by clients
	// Based on the current ForceBeamElement OpenSees manual
	TestNonlocalElement2dDH(int tag, int nodeI, int nodeJ,
...
public:
	...
	const char* getClassType(void) const { return "TestNonlocalElement2dDH"; };
...
#endif // TestNonlocalElement2dDH_H 
