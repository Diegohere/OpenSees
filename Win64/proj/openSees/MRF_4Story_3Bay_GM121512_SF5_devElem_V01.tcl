...
file mkdir MRF_4Story_3Bay_GM121512_SF5_devElem_V01_result;
global Result;
set Result "MRF_4Story_3Bay_GM121512_SF5_devElem_V01_result";
...
# Displacement of equal dof master node in z direction (for verification);
recorder Node -file $Result/equalDOFmasterNodeDispZ.txt  -time  -node 2102  3102  4102  5102  -dof 3 disp;#equal DOF master node
...
set GMfile "GroundMotions-FEMA/121512.th";      # ground motion filename
set dt 0.0100;					# timestep of input GM file
set Scalefact 5.0000;				# ground motion scaling factor
set TotalNumberOfSteps 2800;	# number of steps in ground motion
...
DynamicAnalysis_V03        $dt  $dt_analysis  $GMtime    4       0.12    $FloorNodes     4300.0000      4000.0000;
