...
###################################################################################################
	...
	set dataDir resultsTestElement_WF_Monotonic;			# name of output folder
...
# Record displacements 
	recorder Node -file $dataDir/W625MC30_Cravero2020_lc15bfIP9_Disp.txt -node 2 -dof 1 2 disp;
	
# Record reactions
	recorder Node -file $dataDir/W625MC30_Cravero2020_lc15bfIP9_RBase.txt -node 1 -dof 1 2 6 reaction;
	
# Record stress and strains for fibers
#recorder Element -file $dataDir/W625MC30_Cravero2020_lc15bfIP9_strainFiberExtremePos.txt -ele 12 section 1 fiber 170.7 32.13 strain; 
#ecorder Element -file $dataDir/W625MC30_Cravero2020_lc15bfIP9_strainFiberExtremeNeg.txt -ele 12 section 1 fiber -170.7 32.13 strain;
...
# analysis commands
	...
	#algorithm NewtonLineSearch Secant -tol 0.75;					# use Newton's solution algorithm: updates tangent stiffness at every iteration
