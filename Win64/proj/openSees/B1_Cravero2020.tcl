...
###################################################################################################
	...
	set dataDir resultsB1_Cravero2020;			# name of output folder
...
# Record displacements 
	recorder Node -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_Disp.txt -node 2 -dof 1 2 disp;
	
# Record reactions
	recorder Node -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_RBase.txt -node 1 -dof 1 2 6 reaction;
...
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY172Z0.txt -ele 12 section 1 fiber 172.17 0.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY172Z0.txt -ele 12 section 1 fiber 172.17 0.00 strain; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY134Z0.txt -ele 12 section 1 fiber 133.91 0.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY134Z0.txt -ele 12 section 1 fiber 133.91 0.00 strain; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY96Z0.txt -ele 12 section 1 fiber 95.65 0.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY96Z0.txt -ele 12 section 1 fiber 95.65 0.00 strain; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY57Z0.txt -ele 12 section 1 fiber 57.39 0.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY57Z0.txt -ele 12 section 1 fiber 57.39 0.00 strain; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY19Z0.txt -ele 12 section 1 fiber 19.13 0.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY19Z0.txt -ele 12 section 1 fiber 19.13 0.00 strain; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY-19Z0.txt -ele 12 section 1 fiber -19.13 0.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY-19Z0.txt -ele 12 section 1 fiber -19.13 0.00 strain; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY-57Z0.txt -ele 12 section 1 fiber -57.39 0.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY-57Z0.txt -ele 12 section 1 fiber -57.39 0.00 strain; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY-96Z0.txt -ele 12 section 1 fiber -95.65 0.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY-96Z0.txt -ele 12 section 1 fiber -95.65 0.00 strain; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY-134Z0.txt -ele 12 section 1 fiber -133.91 0.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY-134Z0.txt -ele 12 section 1 fiber -133.91 0.00 strain; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY-172Z0.txt -ele 12 section 1 fiber -172.17 0.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY-172Z0.txt -ele 12 section 1 fiber -172.17 0.00 strain; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_stressFiberY-202Z33.txt -ele 12 section 1 fiber -202.40 33.00 stress; 
recorder Element -file $dataDir/B1_Cravero2020_lc10bfLcSurDx2_strainFiberY-202Z33.txt -ele 12 section 1 fiber -202.40 33.00 strain; 
