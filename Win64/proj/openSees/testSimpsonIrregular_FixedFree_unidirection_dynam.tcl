...
###################################################################################################
	...
	set dataDir results_testSimpsonIrregular_FixedFree_unidirection;			# name of output folder
...
# define section
	...
	# set sigmaC0_Web [expr 1.21*370.5703];
	# set sigmaC0_Flange [expr 1.0* 511.1520];
	set sigmaC0_Web [expr 121000000*370.5703];
	set sigmaC0_Flange [expr 100000000* 511.1520];
...
# define fiber beam-column elements
	...
	nDMaterial ElasticIsotropic 2 $E $nu
	...
	element testNonlocalElementDH 12 1 2 $ColTransfTag $integration 20 1e-6 $lc
...
# Record displacements 
	recorder Node -file $dataDir/equalSpace_21IPs_Disp.txt -node 2 -dof 1 2 3 4 5 6 disp;
	
# Record reactions
	recorder Node -file $dataDir/equalSpace_21IPs_RBase.txt -node 1 -dof 1 2 3 4 5 6 reaction;
	recorder Node -file $dataDir/equalSpace_21IPs_RTop.txt -node 2 -dof 1 2 3 4 5 6 reaction;
	

# #Irregular soace
# # Record displacements 
	# recorder Node -file $dataDir/irregularSpace_2-1-2IPs_Disp.txt -node 2 -dof 1 2 3 4 5 6 disp;
	
# # Record reactions
	# recorder Node -file $dataDir/irregularSpace_2-1-2IPs_RBase.txt -node 1 -dof 1 2 3 4 5 6 reaction;
	# recorder Node -file $dataDir/irregularSpace_2-1-2IPs_RTop.txt -node 2 -dof 1 2 3 4 5 6 reaction;
...
set FloorNodes [list  1 2 ]; 
	...
	DynamicAnalysis_V04        $dt  1.0  $GMtime    1       0.8    $FloorNodes     3900.0      3900.0 2;
