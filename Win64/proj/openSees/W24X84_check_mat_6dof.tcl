...
nDMaterial LocalBucklingWebPlate $IDsteelWeb 29000.0 0.3 55.0 17.8 19.74 20.81 248.14 2 4589.0 277.32 224.6 9.04 20.75 0.5 57.0 1;
...
#  section: 
    ...
    section NDFiber $ColSecTag {;	# Define the fiber section, G value must be passed instead of GJ in the same command
	...
	section NDFiber $ImperfectColSecTag {;	# Define the fiber section, G value must be passed instead of GJ in the same command
