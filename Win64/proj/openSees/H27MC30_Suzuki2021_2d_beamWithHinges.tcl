...
###################################################################################################
	...
	set dataDir results4Paper_H27C_Suzuki2021_2dCFSTSteel_V02;			# name of output folder
...
# define fiber beam-column elements
	...
	#element testNonlocalElementDH 12 1 2 $ColTransfTag Simpson 1 13  5000 1e-8 $lc
	#element gradientForceBeamColumn 12 1 2 $ColTransfTag Simpson 1 9  20 1e-6 $lc
	
	element forceBeamColumn 12 1 2 $ColTransfTag "HingeRadau 1 $lc 1 $lc 1" -iter 20 1e-6
...
# Record displacements 
	recorder Node -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_Disp.txt -node 2 -dof 1 2 disp;
	
# Record reactions
	recorder Node -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_RBase.txt -node 1 -dof 1 2 3 reaction;
	
# Record section deformations
	recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_section1Deformation.txt -ele 12 section 1 deformation;
	
# Record local section deformations
   #recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_curvatureLoc.txt -ele 12 LocalSectionCurvature;
   
# Record nonlocal section deformations
   #recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_curvatureNonloc.txt -ele 12 NonlocalSectionCurvature;
	
# Record stress and strains for the external fibers in the flanges
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY-117Z117.txt -ele 12 section 1 fiber -116.69 116.69 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY-117Z117.txt -ele 12 section 1 fiber -116.69 116.69 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY-93Z122.txt -ele 12 section 1 fiber -92.92 122.25 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY-93Z122.txt -ele 12 section 1 fiber -92.92 122.25 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY-72Z122.txt -ele 12 section 1 fiber -72.28 122.25 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY-72Z122.txt -ele 12 section 1 fiber -72.28 122.25 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY-52Z122.txt -ele 12 section 1 fiber -51.63 122.25 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY-52Z122.txt -ele 12 section 1 fiber -51.63 122.25 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY-31Z122.txt -ele 12 section 1 fiber -30.98 122.25 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY-31Z122.txt -ele 12 section 1 fiber -30.98 122.25 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY-10Z122.txt -ele 12 section 1 fiber -10.33 122.25 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY-10Z122.txt -ele 12 section 1 fiber -10.33 122.25 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY10Z122.txt -ele 12 section 1 fiber 10.33 122.25 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY10Z122.txt -ele 12 section 1 fiber 10.33 122.25 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY31Z122.txt -ele 12 section 1 fiber 30.97 122.25 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY31Z122.txt -ele 12 section 1 fiber 30.97 122.25 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY52Z122.txt -ele 12 section 1 fiber 51.62 122.25 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY52Z122.txt -ele 12 section 1 fiber 51.62 122.25 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY72Z122.txt -ele 12 section 1 fiber 72.27 122.25 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY72Z122.txt -ele 12 section 1 fiber 72.27 122.25 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY93Z122.txt -ele 12 section 1 fiber 92.92 122.25 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY93Z122.txt -ele 12 section 1 fiber 92.92 122.25 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY117Z117.txt -ele 12 section 1 fiber 116.69 116.69 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY117Z117.txt -ele 12 section 1 fiber 116.69 116.69 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY122Z77.txt -ele 12 section 1 fiber 122.25 77.44 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY122Z77.txt -ele 12 section 1 fiber 122.25 77.44 strain; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_stressFiberY-122Z77.txt -ele 12 section 1 fiber -122.25 77.44 stress; 
#recorder Element -file $dataDir/H27MC30_Suzuki2021_beamWithHinges_strainFiberY-122Z77.txt -ele 12 section 1 fiber -122.25 77.44 strain; 
