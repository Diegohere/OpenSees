...
recorder Node -file $Result/3dModel_lc10D_FloorDispX.txt  -time  -node 011103  011203  011303  021103  021203  021303  112102  112202  112302  122102  122202  122302  113102  113202  113302  123102  123202  123302  114102  114202  114302  124102  124202  124302  115102  115202  115302  125102  125202  125302  -dof 1 disp;#Left middle of panel zone
# Floor Lateral Displacement in Z direction;
recorder Node -file $Result/3dModel_lc10D_FloorDispZ.txt  -time  -node 011103  011203  011303  021103  021203  021303  212102  212202  212302  222102  222202  222302  213102  213202  213302  223102  223202  223302  214102  214202  214302  224102  224202  224302  215102  215202  215302  225102  225202  225302  -dof 3 disp;#Left middle of panel zone
# Column Displacement in Y direction (i.e. axial);
recorder Node -file $Result/3dModel_lc10D_ColumnStorey1DispY.txt  -time  -node 012101  012201  012301  022101  022201  022301  -dof 2 disp;#Column top node
# Column Displacement in X direction;
recorder Node -file $Result/3dModel_lc10D_ColumnStorey1DispX.txt  -time  -node 012101  012201  012301  022101  022201  022301  -dof 1 disp;#Column top node
# Column Displacement in Z direction;
recorder Node -file $Result/3dModel_lc10D_ColumnStorey1DispZ.txt  -time  -node 012101  012201  012301  022101  022201  022301  -dof 3 disp;#Column top node
# Reaction Forces  in X direction ;
recorder Node -file $Result/3dModel_lc10D_ReactionX.txt -time  -node 011103  011203  011303  021103  021203  021303  -dof 1 reaction;
# Reaction Forces  in Z direction ;
recorder Node -file $Result/3dModel_lc10D_ReactionZ.txt -time  -node 011103  011203  011303  021103  021203  021303  -dof 3 reaction;
# Reaction Forces Vertical (Y) direction;
recorder Node -file $Result/3dModel_lc10D_ReactionY.txt -time  -node 011103  011203  011303  021103  021203  021303  -dof 2 reaction;
