...
# define fiber beam-column elements
	...
	element forceBeamColumn 12 1 2 $ColTransfTag "HingeRadau 1 $lc 1 $lc 1" -iter 1000 1e-4
...
# Record location integration points
	recorder Element -file $dataDir/B1_Cravero2020_beamWithHinges_integrationPoints.txt -ele 12 integrationPoints;
