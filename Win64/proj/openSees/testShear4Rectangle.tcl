...
###################################################################################################
	...
	set dataDir results_testShear4Rectangle;			# name of output folder
...
# define rectangular section
	set h  200.0;										# section height
	set b  50;										# section thickness
...
# define fiber beam-column elements
	...
	set do 	[expr $h]; 			# median depth
	set J   [expr 1.0/3.0*($do*$b**3.0)]; 		# torsional constant   
