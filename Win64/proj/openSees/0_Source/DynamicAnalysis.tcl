...
set nr_iter_1 100;
set nr_iter_2 200;
set nr_analyse 10; # 1/20/50/100 This is the number of steps to do in a current solver
...
set dt_anal_min1 [expr $dt_anal_Step/100]; # minimum time step for Variable Transient Analysis
