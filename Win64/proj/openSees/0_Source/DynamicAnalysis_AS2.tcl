...
set dt_anal_min [expr $dt_anal_Step/60]; # minimum time step for Variable Transient Analysis
set dt_anal_max [expr $dt_anal_Step*2]; # maximum time step for Variable Transient Analysis
set nr_iter 20; # Number of maximum iterations for Variable Transient Analysis
